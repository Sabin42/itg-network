...
module.exports = function (_Error) {
  ...
  function NpmRunAllError(causeResult, allResults) {
     ...
     * @type {string}
     */
    var _this = _possibleConstructorReturn(this, (NpmRunAllError.__proto__ || Object.getPrototypeOf(NpmRunAllError)).call(this, "\"" + causeResult.task + "\" exited with " + causeResult.code + "."));
