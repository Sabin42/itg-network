...
var EC = require('./expectedConditions');
...
var logger = new logger2_1.Logger('protractor');
/*
 ...
 * @type {ProtractorBy}
 */
exports.By = new locators_1.ProtractorBy();
/**
 * @type {ExpectedConditions}
 */
exports.ExpectedConditions = new EC.ExpectedConditions();
/**
 ...
 */
function buildElementHelper(ptor) {
    var element = function (locator) {
        return new element_1.ElementArrayFinder(ptor).all(locator).toElementFinder_();
    };
    element.all =
        function (locator) {
            return new element_1.ElementArrayFinder(ptor).all(locator);
        };
    return element;
}
;
...
var Protractor = (function () {
    function Protractor(webdriverInstance, opt_baseUrl, opt_rootElement, opt_untrackOutstandingTimeouts) {
        var _this = this;
        /**
       ...
       */
        this.forkNewDriverInstance = null;
        /**
   ...
   * @template T
   */
    Protractor.prototype.executeAsyncScript_ = function (script, description) {
        var scriptArgs = [];
        for (var _i = 2; _i < arguments.length; _i++) {
            scriptArgs[_i - 2] = arguments[_i];
        }
    ...
    Protractor.prototype.waitForAngular = function (opt_description) {
        ...
        var runWaitForAngularScript = function () {
            if (_this.plugins_.skipAngularStability()) {
                ...
                return _this.executeAsyncScript_(clientSideScripts.waitForAngular, 'Protractor.waitForAngular()' + description, _this.rootEl);
            }
            else {
        ...
        return runWaitForAngularScript()
            ...
            return _this.driver.controlFlow()
                .execute(function () { return _this.plugins_.waitForPromise(); }, 'Plugins.waitForPromise()')
                .then(function () {
   ...
   */
    Protractor.prototype.get = function (destination, opt_timeout) {
        ...
        if (this.ignoreSynchronization) {
            ...
            return this.driver.controlFlow().execute(function () { return _this.plugins_.onPageLoad(); });
        }
        ...
        this.driver
            ...
            return _this
                ...
                .then(function (url) { return url !== _this.resetUrl; }, function (err) {
                if (err.code == 13) {
            ...
            .then(null, deferred.reject);
        this.driver.controlFlow().execute(function () { return _this.plugins_.onPageLoad(); });
        // Make sure the page is an Angular page.
        this.executeAsyncScript_(clientSideScripts.testForAngular, msg('test for angular'), Math.floor(timeout / 1000))
        ...
        this.driver.controlFlow().execute(function () {
            return self.plugins_.onPageStable().then(function () { deferred.fulfill(); }, function (error) { deferred.reject(error); });
        });
   ...
   */
    Protractor.prototype.refresh = function (opt_timeout) {
        ...
        return this
            ...
            .then(function (href) { return _this.get(href, opt_timeout); });
    };
    ;
    /**
   ...
   */
    ...
    Protractor.prototype.debugger = function () {
        ...
        webdriver.promise.controlFlow().execute(function () { debugger; }, 'add breakpoint to control flow');
    };
    ;
    /**
    ...
    Protractor.prototype.validatePortAvailability_ = function (port) {
        ...
        tester.once('error', function (err) {
            if (err.code === 'ECONNREFUSED') {
                tester.once('close', function () { doneDeferred.fulfill(true); }).end();
            }
            else {
    ...
    Protractor.prototype.initDebugger_ = function (debuggerClientPath, onStartFn, opt_debugPort) {
        ...
        global.list = function (locator) {
            ...
            return browser.findElements(locator).then(function (arr) {
                ...
                for (var i = 0; i < arr.length; ++i) {
                    arr[i].getText().then(function (text) { found.push(text); });
                }
                return found;
            });
        };
        ...
        this.dbgCodeExecutor_ = {
            ...
            execute_: function (execFn_) {
                ...
                this.execPromise_ = this.execPromise_.then(execFn_).then(function (result) { _this.execPromiseResult_ = result; }, function (err) { _this.execPromiseError_ = err; });
 ...
 * @return {Protractor}
 */
exports.wrapDriver = function (webdriver, baseUrl, rootElement, untrackOutstandingTimeouts) {
    return new Protractor(webdriver, baseUrl, rootElement, untrackOutstandingTimeouts);
};
