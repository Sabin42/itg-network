...
var ExpectedConditions = (function () {
    ...
    ExpectedConditions.prototype.not = function (expectedCondition) {
        return function () {
            return expectedCondition().then(function (bool) { return !bool; });
        };
    };
    /**
    ...
    ExpectedConditions.prototype.alertIsPresent = function () {
        return function () {
            return browser.switchTo().alert().then(function () { return true; }, function (err) {
    ...
    ExpectedConditions.prototype.titleIs = function (title) {
        return function () {
            return browser.getTitle().then(function (actualTitle) { return actualTitle === title; });
        };
    };
    /**
