...
var logger = new logger2_1.Logger('element');
 ...
 */
var ElementArrayFinder = (function () {
    function ElementArrayFinder(ptor_, getWebElements, locator_, actionResults_) {
        var _this = this;
        ...
        WEB_ELEMENT_FUNCTIONS.forEach(function (fnName) {
            _this[fnName] = function () {
                ...
                var actionFn = function (webElem) { return webElem[fnName].apply(webElem, args); };
    ...
    ElementArrayFinder.prototype.clone = function () {
        ...
        return new ElementArrayFinder(this.ptor_, this.getWebElements, this.locator_, this.actionResults_);
    };
    /**
        ...
        var getWebElements = function () {
            return _this.getWebElements().then(function (parentWebElements) {
                var list = parentWebElements.map(function (parentWebElement, index) {
                    var elementFinder = ElementFinder.fromWebElement_(_this.ptor_, parentWebElement, _this.locator_);
     ...
     */
    ElementArrayFinder.prototype.first = function () { return this.get(0); };
    ;
    /**
     ...
     */
    ElementArrayFinder.prototype.last = function () { return this.get(-1); };
    /**
     ...
     */
    ElementArrayFinder.prototype.locator = function () { return this.locator_; };
    /**
    ...
    ElementArrayFinder.prototype.asElementFinders_ = function () {
        ...
        return this.getWebElements().then(function (arr) {
            return arr.map(function (webElem) {
                return ElementFinder.fromWebElement_(_this.ptor_, webElem, _this.locator_);
            });
        });
    };
    /**
    ...
    ElementArrayFinder.prototype.each = function (fn) {
        return this.map(fn).then(function () { return null; });
    };
    /**
...
var ElementFinder = (function () {
    function ElementFinder(ptor_, elementArrayFinder) {
        var _this = this;
        this.ptor_ = ptor_;
        this.then = null;
        ...
        this.elementArrayFinder_ = new ElementArrayFinder(this.ptor_, getWebElements, elementArrayFinder.locator(), elementArrayFinder.actionResults_);
        WEB_ELEMENT_FUNCTIONS.forEach(function (fnName) {
            _this[fnName] = function () {
                var args = [];
                for (var _i = 0; _i < arguments.length; _i++) {
     ...
     * @return {webdriver.Locator}
     */
    ElementFinder.prototype.locator = function () { return this.elementArrayFinder_.locator(); };
    /**
...
exports.build$ = function (element, by) {
    return function (selector) { return element(by.css(selector)); };
};
/**
 * Shortcut for querying the document directly with css.
 ...
 */
exports.build$$ = function (element, by) {
    return function (selector) { return element.all(by.css(selector)); };
};
