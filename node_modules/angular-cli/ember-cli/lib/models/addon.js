...
*/
Addon.prototype.treeForApp = function(tree) {
  return tree;
};
...
*/
Addon.prototype.treeForTemplates = function(tree) {
  return tree;
};
...
*/
Addon.prototype.treeForAddonTemplates = function(tree) {
  return tree;
};
...
*/
Addon.prototype.treeForVendor = function(tree) {
  return tree;
};
...
*/
Addon.prototype.treeForTestSupport = function(tree) {
  return tree;
};
...
Addon.prototype._addonTemplateFiles = function addonTemplateFiles(tree) {
  this._requireBuildPackages();
...
/**
  ...
  @param {Array} args the arguments to pass to the invoked method
*/
Addon.prototype._eachProjectAddonInvoke = function eachProjectAddonInvoke(methodName, args) {
  this.initializeAddons();
